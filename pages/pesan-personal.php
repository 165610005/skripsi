  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        ?>
        <form action="cproses/zenziva.php?act=<?= md5('single');?>" method="post">
          <div class="row">
            <div class="col-md-4">
              <div class="card card-primary">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control select2" name="penerima" data-placeholder="Cari nama siswa atau orang tua wali" required style="width: 100%;">
                      <option value=""></option>
                      <?php
                        foreach ($sr->showKontak() as $ct) {
                          if(isset($_GET['id']) == $ct){
                      ?>
                        <option value="<?= $ct['id_kontak'];?>" selected><?= $ct['nama']." - ".$ct['nama_wali'];?></option>
                      <?php
                          } else {
                      ?>
                        <option value="<?= $ct['id_kontak'];?>"><?= $ct['nama']." - ".$ct['nama_wali'];?></option>
                      <?php
                          }
                        }
                      ?>
