                    ...
                    <table id="example2" class="table table-bordered table-striped">
                        ...
                        <tbody>
                          ...
                          <tr>
                              ...
                              <td><?= $sk['no_hp'];?></td>
                              <td align="center">
                                <a href="cproses/delete.php?act=<?= md5('delanggota');?>&id=<?= $_GET['id'];?>&ids=<?= $sk['id_siswa'];?>" onclick="return confirm('Apa Anda Akan Menghapus Data Dari Group?')" class="btn btn-sm btn-danger"><i class="fas fa-trash"></i></a>
                              </td>
                          </tr>
                          <?php
                            }
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                          ...
                          <tr>
                              ...
                              <td><?= $sk['no_hp'];?></td>
                              <td align="center">
                                <a href="cproses/insert.php?act=<?= md5('addAnggota');?>&id=<?= $_GET['id'];?>&ids=<?= $sk['ids'];?>" class="btn btn-sm btn-info"><i class="fas fa-plus"></i> Masukkan Group</a>
                              </td>
                          </tr>
                          <?php
                            }
